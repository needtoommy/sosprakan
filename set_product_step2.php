                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" aria-current="page" href="set_product_step2_1.php?supliername=<?php echo $_GET['supliername'] ?>" style="cursor: pointer;">ชั้น1</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="set_product_step2_2.php?supliername=<?php echo $_GET['supliername'] ?>" style="cursor: pointer;">ชั้น2</a>
                                                    </li>
                                                    <li class="nav-item">
